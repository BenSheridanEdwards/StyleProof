...
${block}`),
  ...
  const readmeMarker = readme.indexOf('<!-- styleproof-report -->');
  const readmeDecision = readme.indexOf(block, readmeMarker);
  assert.ok(readmeMarker >= 0 && readmeDecision > readmeMarker);
});
