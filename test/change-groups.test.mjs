...
test('cleanFindingsForDisplay: same-length geometry remains reviewable while changed-length geometry does not', () => {
  ...
  assert.equal(cleanFindingsForDisplay([{ ...geometry, contentLengthChanged: true }]).length, 0);
});
