...
| `report-retention-days` | `30`                         | Days the report artifact is kept when `report-storage` is `artifact` (GitHub bounds 1–90). Must be a positive integer in either mode.                                                                                                           |
