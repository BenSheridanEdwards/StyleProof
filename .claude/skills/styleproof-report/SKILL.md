...
📐 inventory (additions and removals both echoed), and data-residue verdicts — so
a reviewer sees what the green actually asserts before the pretty crops. The PR
comment itself stays lean (summary + approval box) and links to the committed
full report.
