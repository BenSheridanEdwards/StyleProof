...
| Code  | Meaning                                                                                                                                                                                                                                                                                         |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0** | identical — certified only when source-bound (`--expected-before-sha`/`--expected-after-sha`); unbound runs print `UNVERIFIED DIAGNOSTIC (not certified: unbound)` with `certifiesFully: false`                                                                                                 |
