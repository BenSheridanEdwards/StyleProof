...
⚠️ **1 baseline capture failure(s)**: these named surface(s) failed on the base SHA and were omitted from the baseline bundle: `about@auto` at `9a1b4c147851e6a137cb81582e9dbe9839ef5e7e`. The base bundle was produced (`base-capture-failed=false`); this is not a base recapture failure. Repair the named surface(s) on that SHA; do not approve indefinitely. Raw exception details stay private.
...
- `about@auto` · `capture_failed` · `9a1b4c147851e6a137cb81582e9dbe9839ef5e7e`
...
<!-- styleproof-receipt head-sha:d9720e7258a7a0a3aee94aa625cbb7aa4b5959bc run-id:36251728024 run-attempt:1 -->
