...
clean before/after crop and the annotated evidence, not a pass/fail score alone._
...
These are current screenshots of StyleProof's public dogfood checks and generated
report. They are not design mockups.

### No computed-style drift

[![A real StyleProof dogfood receipt reporting that all captured surfaces are identical](docs/readme/check-clean.png)](https://github.com/BenSheridanEdwards/StyleProof/blob/styleproof-action-dogfood/pr-271/report.md)

The receipt says what matched and what was not proved. Missing coverage,
determinism, or inventory evidence stays visible instead of being flattened into
a reassuring green.
