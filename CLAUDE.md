...
This project is indexed by GitNexus as **styleproof** (1598 symbols, 3888 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
